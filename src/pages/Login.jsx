...
export default function Login() {
  ...
  const inp = {
    ...
    fontSize: '0.88rem', color: '#f0f0f0', outline: 'none',
  ...
  return (
    <div style={{ height: 'calc(100vh - 72px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 1.5rem', overflow: 'hidden', paddingBottom: '6vh' }}>
      {/* Ambient glow */}
      <div style={{ position: 'fixed', top: '40%', left: '50%', transform: 'translate(-50%,-50%)', width: 560, height: 420, background: 'radial-gradient(circle, rgba(184,212,232,0.06) 0%, transparent 70%)', pointerEvents: 'none', borderRadius: '50%' }} />
      ...
      >
        ...
        <div className="glass" style={{ borderRadius: 26, padding: '2.5rem' }}>
          <form onSubmit={submit}>
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ position: 'relative' }}>
                <Mail size={13} style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.22)', pointerEvents: 'none' }} />
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <div style={{ position: 'relative' }}>
                <Lock size={13} style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.22)', pointerEvents: 'none' }} />
                ...
                <button type="button" onClick={() => setShow(!show)} style={{ position: 'absolute', right: 13, top: '50%', transform: 'translateY(-50%)', color: 'rgba(255,255,255,0.25)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
          ...
          <div style={{ marginTop: 24, paddingTop: 22, borderTop: '1px solid rgba(255,255,255,0.06)', textAlign: 'center' }}>
            <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.3)' }}>
              Don't have an account?{' '}
              <Link to="/register" style={{ color: '#B8D4E8', textDecoration: 'none', fontWeight: 400 }}
