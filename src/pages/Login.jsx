          ...
          <form onSubmit={submit}>
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ position: 'relative' }}>
                <Mail size={13} style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', color: 'rgba(var(--rgb-hi),0.22)', pointerEvents: 'none' }} />
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <div style={{ position: 'relative' }}>
                <Lock size={13} style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', color: 'rgba(var(--rgb-hi),0.22)', pointerEvents: 'none' }} />
                ...
                <button type="button" onClick={() => setShow(!show)} style={{ position: 'absolute', right: 13, top: '50%', transform: 'translateY(-50%)', color: 'rgba(var(--rgb-hi),0.25)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
